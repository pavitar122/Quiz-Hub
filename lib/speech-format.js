...
export function getListenSegments(item, qIdx) {
  ...
  return [
    { key: "question", label: "Question", text: `Question ${qIdx + 1}. ${questionText}`, gap: 650 },
    { key: "options",  label: "Options",  text: `Options. ${optionText}`, gap: 850 },
    { key: "answer",   label: "Answer",   text: `Answer. ${correctText}`, gap: 700 },
    { key: "expl",     label: "Explanation", text: `Explanation. ${explText}`, gap: 500 },
